<?php session_start();
    ...
    $vsql = mysqli_query($conn,"SELECT * FROM t_courses WHERE C_number=2");
                ...
                $_SESSION['cnum2'] = $viewc1['C_number'];
        ...
        if(isset($_POST['reg-c'])){
            if(empty($_SESSION['name'])){
                ...
                if($_SESSION['path'] == 'trainers'){
                    if ($_SESSION['name'] == $_SESSION['lec_courses2']){
                    ...
                    $user_num = $_SESSION['user_num'];
                            ...
                            if(mysqli_num_rows($sqlcheck) == 1){
                                ...
                                values('$user_num','$cnum','$cname','$fname','$lname')") or die(mysqli_error($conn));
                                 ...
                                 $_SESSION['course'] = 2;
                                  header('location: course-content2.php');
                            }
                }
            }
...
<head> 
    ...
    <title>  <?php  echo $_SESSION['cname2']; ?> </title>
        ...
        <form action="courses2.php" method="post">
            <div class="div_courses_t">
                ...
                <div class="c1_info">
                    ...
                    <ul>
                        <li>مقدمة عن التصميم.</li>
                        <li>أهم البرامج التي تحتاجها.</li>

                    </ul>
                    <h1>معلومات الدوره:</h1>
                    <ul>
                        <li>مدة الدوره: <?php echo $_SESSION['dtime2']; ?></li>
                        <li>تاريخ الدوره: <?php if($_SESSION['cdate2'] != '0000-00-00' ){ echo $_SESSION['cdate2']; }else{
                            echo 'لا يوجد تاريخ محدد للدوره';
                        } ?></li>
                        <li>وقت بداية الدوره: <?php if($_SESSION['stime2'] != '00:00:00' ){ echo $_SESSION['stime2']; }else{
                            echo 'لا يوجد وقت بداية للدوره';
                        }  ?> </li>
                        <li>وقت نهاية الدوره: <?php if($_SESSION['etime2'] != '00:00:00' ){ echo $_SESSION['etime2']; }else{
                            echo 'لا يوجد وقت نهاية للدوره';
                        }  ?> </li>
                        <li>شروط الدوره: <?php if($_SESSION['req_name2'] != '' ){ echo $_SESSION['req_name2']; }else{
                            echo 'لا يوجد شروط للدوره';
                        }  ?> </li>
                        <li>سعر الدوره: <?php if($_SESSION['price2'] != 0 ){ echo $_SESSION['price2']; echo ' ريال '; }else{
                            echo 'الدوره مجانيه';
                        }  ?> </li>
                        <li>مقدم الدوره: <?php echo $_SESSION['lec_courses2']; ?></li>
